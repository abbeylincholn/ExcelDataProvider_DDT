...
public class UploadDownload {
    public static void main(String[] args) throws IOException {
        ...
        String fileName = System.getProperty("user.home")
                + "\\OneDrive\\Desktop\\BACKUP\\Software\\UdemySelenium\\Resources\\download.xlsx";
        ...
        upload.sendKeys("C:\\Users\\abbey\\Downloads\\download.xlsx");
    ...
    private static boolean updateCell(String fileName, int row, int col, String updatedValue) throws IOException, IOException {
